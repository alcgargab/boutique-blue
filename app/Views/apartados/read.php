    <div class="container mt-5">
        <div class="row featurette">
            <div class="col-md-7 order-md-2">
                ...
                <p>
                    <span class="text-muted">
                        ...
                        <br><br>
                        <span class="txtAtom">Resta:</span> <?php $flag = $apartados->p_precioVenta - $totalAbonos[0]->totalAbonos;
                                                            echo "$" . number_format($flag, 2); ?>
                        <br><br>
                        <?php
            ...
            <div class="col-md-5 order-md-1">
                <svg class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500" xmlns="<?= base_url() ?>public/images/productos/<?= $apartados->p_imagen ?>" role="img" aria-label="<?= $apartados->p_nombre ?>" preserveAspectRatio="xMidYMid slice" focusable="false">
                    <title><?= $apartados->p_nombre ?></title>
                    <rect width="100%" height="100%" fill="#eee" /><text x="50%" y="50%" fill="#aaa" dy=".3em"><?= $apartados->p_nombre ?></text>
                </svg>
            </div>
        </div>
        <div class="row mt-5">
