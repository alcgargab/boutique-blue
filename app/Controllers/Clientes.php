    ...
    class Clientes extends BaseController
    {
        ...
        public function create()
        {
            ...
            $query_form['cl_whatsapp'] = trim($this -> request -> getPost('cWhatsapp'));
                ...
                //     $query_alert['alert_url'] = "https://wa.me/".$query_form['cl_whatsapp']."?text=Hola ¡*".ucwords(mb_strtolower($query_form['cl_apellido'], "UTF-8"))." ".ucwords(mb_strtolower($query_form['cl_nombre'], "UTF-8"))."*, bienvenid@ a la familia de *Boutique Blue*!";
                // } else {
