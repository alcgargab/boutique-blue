...
function __click() {
    $('#reportD').click(function() {
        ...
        // if (to != "") {
            $.ajax({
                url: "http://192.168.1.73:8585/boutique-blue/ajax/get-ventas-dia",
                type: "post",
                dataType: "html",
                // data: {
                //     to: to
                    ...
                    if (0 != (r = JSON.parse(r)).status) {
                        ...
                        var options = {
                            series: [{
                                ...
                                data: [
                                    for (var s in r.ingresos) "'"+r.ingresos[s].total_ingreso+"',"
                                ]
                            }],
                            chart: {
                                height: 350,
                            ...
                            xaxis: {
                                categories: [
                                    for (var s in r.ingresos) "'"+r.ingresos[s].i_fecha+"'," 
                                ],
                                title: {
                                    text: 'Día'
                                }
